...
//	}
	...
	g_xMainWnd.PutsHan(NULL, rcTitle, RGB(200, 200, 255), RGB(0, 0, 0), "[관범]", g_xMainWnd.CreateGameFont("ms sans serif", 12, 0, FW_BOLD));
	...
	g_xMainWnd.PutsHan(NULL, rcMoney, RGB(200, 200, 255), RGB(0, 0, 0), szMoney, g_xMainWnd.CreateGameFont("ms sans serif", 10, 0, FW_BOLD));
